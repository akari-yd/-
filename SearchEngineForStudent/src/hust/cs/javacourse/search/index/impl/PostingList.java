...
public class PostingList extends AbstractPostingList {
    ...
    public void add(AbstractPosting posting) {
        posting.sort();
        for (AbstractPosting abstractPosting : super.list) {
            if (abstractPosting.equals(posting)) {
                return;
            }
        }
    ...
    public int indexOf(AbstractPosting posting) {
        for(int i=0;i<super.list.size();i++){
            if(super.list.get(i).toString().equals(posting.toString())){
                return i;
            }
        }
        return -1;
    ...
    public boolean contains(AbstractPosting posting) {
        if(this.indexOf(posting)!=-1) return true;
        return false;
    }
